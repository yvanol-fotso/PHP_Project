   ...
   <div class="wrapper">
        ...
        <nav>
          <ul>
            ...
            <li>
              <a href="discussion.php"><img src="static/images/index-icon/notification-icon.png" alt="" width="%;" style="margin-left:15%;"></a>
              <!-- pour acceder au discussion sur gran ecran-->
            </li>
            <li>
        ...
        <!-- block special ici c'est l'images des discussion fixe  petit media (mobile-menu-nav) -->
        <div class="discussionImg"> 
              <a href="discussion.php">
                <img src="static/images/index-icon/notification-icon.png" alt="" width="%;" style="margin-left:35px;">
              </a>
        </div>
        <!-- sa fin -->
