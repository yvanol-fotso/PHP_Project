...
<head>
  ...
  @media only screen and (max-width: 360px) {
    .forget-content{
      ...
      <div class="message-good" id="message-good" style="display: hidden;">
        <p class="goof-msg" id="alertUser" ></p>
      </div>
                ...
                xhttp.onreadystatechange = function () {
                  if (this.readyState == 4 && this.status == 200)
                  {
                    ...
                    if(data['success'] == 0) {	
                      ...
                      document.getElementById('message-good').style.display = 'flex';
                      document.getElementById('alertUser').innerHTML= '<font color="green">' +data['message'] +'</font>';
                      alert(this.response);		
				           }else{
