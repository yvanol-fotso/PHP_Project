...
// destruction du compte de l'utilisateur et tous ses interaction sur le site
...
function detroyUser()
{
    # code...
         ...
         // primo je  le supprime de le table user
        ...
        // //secundo je supprime ses interaction de la table article
        
        // quatro de la table probleme

        // je detruit sa session
        // session_destroy();
