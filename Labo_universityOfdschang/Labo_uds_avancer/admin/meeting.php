...
<head>
	...
	<!-- je use bootstrapp ici -->

	<link rel="stylesheet" type="text/css" href="">

    <link rel="stylesheet" href="asset/css/meeting/bootstrap.min.css">
...
<div class="offset-md-1 offset-sm-2 col-sm-6 col-md-7" id="gob" style="margin-top: 5%; margin-bottom: 5%; margin-left: 20%;">
    ...
    <form action="" method="POST" class="p-3" id="myForm">
        ...
        <a href="include/meet.html" target="_blank"><button id="submit" type="button" class="btn btn-info mt-2 p-1 font-weight-bold mr-4" >Open Meet & Share URL : Create Meeting</button></a>
...
<button id="start" type="button" class="btn btn-white mt-2 p-1 font-weight-bold mr-4" >Start Instant Meeting : Send Mail Tall user</button>
