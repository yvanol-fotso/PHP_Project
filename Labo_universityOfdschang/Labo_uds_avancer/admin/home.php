...
<body>
	<div class="sucess">
		...
		<a href="meeting.php">Create Meeting</a> | 
		...
		<!-- <a href="add_collaborateurs.php">Add Member Etudiant </a> |  -->
		<!-- <a href="delete_partern_collab.php">Delete Member Etudiant</a>| -->
         <a href="add_collaborateur.php">Add Member Collaborateur</a> |
		<a href="delete_collaborateur.php">Delete Member  Collaborateur</a>|
