...
// partie partenaire: collaborateur
 ...
 function listCollaborator()
 {
   ...
   $query = "SELECT id_col,image,home_page,nom,description FROM collaborateur ";
         ...
         $container .= '
          ...
          <div class="collaborateur_description">
             ...
             <div class="collaborateur_info">
               <p class="collaborateur_name">Nom : ' .$row['nom'].' </p>
               <p class="collaborateur_link"> <a href=" '.$row['home_page'].' " target="_blank"> page </a> </p>
             </div>
  ...
  if (empty($container)) {
    echo "<font style='margin-left:40%;' color=green><b><i> AUCUN COLLABORATEUR </font>";
  }else{
   echo $container;
...
// partie partenaire: membre
 ...
 function listMembre()
 {
   ...
   $query = "SELECT id_part,image,description ,date_format(date, '%Y/%m/%d') AS date FROM member ORDER BY date DESC";
      ...
      while ($row = $stmt->fetch(PDO::FETCH_ASSOC) ){
         ...
         $container .= '
          ...
          <div class="collaborateur_description">
             <img class="collaborateur_img"src=" '.$path.'/'.$row['image'].'  " />
             <div class="collaborateur_info">
               <p class="collaborateur_link"> <a href="membresDetail.php?detail='.$row['id_part'].' "> Detail </a> </p>
