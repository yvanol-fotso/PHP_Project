...
<!-- profile  -->
	 <section class="content">
	 	    <h1 class="title">  Mon Profil</h1>
	 	  	...
	 	  	<button class="editer"><a href="edit_profil.php" class="">Editer Le Profil</a></button>
			<button class="post-button"><a href="#publication-block" class="">Inserer un article</a></button>
	 </section>
   ...
   <!-- publication   -->
	<div class="my-post" style="">
     ...
     <?php  foreach ($result as $resul): {
		 ...
		 <p id ="prett">
		 	<p class="pret-name">De Mr : <font class="color" style="color: #09F;"> <?= $res['nom'];?> </font> &Aacute; <?= $resul['date'];?></p>
