...
<head>
	<title>delete_Partenaire University</title>
...
<body>
     ...
     <?php 
      ...
      if(isset($_GET['id_part'])){
        ...
        $sql = "DELETE FROM partenaire_university WHERE id_part=:id";
   ...
   ?>
    ...
    <h2> Supprimer Une Partenaire Universitaire</h2>
     <button class="back"><a href="home.php">Back To Admin Space</a></button>


      <?php  

        $sql = "SELECT * FROM partenaire_university";
...
<?php foreach ($res as $value): ?>
	...
	<div class="delete_Partenaire">
          <img class="delete_partenaire_" src="<?=$value['image'];?>" width="40">
