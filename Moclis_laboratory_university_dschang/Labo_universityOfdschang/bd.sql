...
INSERT INTO `member` (`id_part`,`image`,`nom`,`description`,`date`) VALUES( 13,'asset/alimentation/collaborateur/profil.jpg','MABEKOU TAKAM JEANNE SANDRINE','MY research : Structure mecanique et physique et systèmes physique , Dynamique non Lineaire','2022/02/01');
...
INSERT INTO `collaborateur` (`id_col`,`image`,`home_page`,`nom`,`description`) VALUES( 1,'asset/alimentation/collaborateur/hcerdeira.jpg','https://hcerdeira','Hilda A. Cerdeira','Instuto de Fisica Teorica-UNESP  R.Dr.Bento Teobadlo Ferraz,271 - Bloco II ...');
INSERT INTO `collaborateur` (`id_col`,`image`,`home_page`,`nom`,`description`) VALUES( 2,'asset/alimentation/collaborateur/samuel-bowong.png','https://fr.wikipedia.org/wiki/Samuel_Bowong_Tsakou','Samuel Bowong Tsakou','Enseignant et chercheur Camerounais en mathematiques ....');
INSERT INTO `collaborateur` (`id_col`,`image`,`home_page`,`nom`,`description`) VALUES( 3,'asset/alimentation/collaborateur/perfil_fernando-f-ferreira.jpg','https://jornal.usp.br.articulista/fernando-fagundes-ferreira/','Fernando Fagundes Ferreira','Professor da Escola de Artes,Ciencias e Humanidades (EACH) da USP .Tem experienca nas aeras de modelos ...');
INSERT INTO `collaborateur` (`id_col`,`image`,`home_page`,`nom`,`description`) VALUES( 4,'asset/alimentation/collaborateur/djukeu-frank.jpg','https://vision.gel.ulaval.ca/fr/people/ld_694/index.php','Djukeu Ftrank Billy','Laboratoire de Vision et  Numerique numerique');
INSERT INTO `collaborateur` (`id_col`,`image`,`home_page`,`nom`,`description`) VALUES( 5,'asset/alimentation/collaborateur/profil.jpg','https://www.facebook.com/hilairebertrand.fotsin','Hilaire Betrand Fotsin','Enseignant de physics &aacute; l\'universit&eacute; de Dschang');
INSERT INTO `collaborateur` (`id_col`,`image`,`home_page`,`nom`,`description`) VALUES( 6,'asset/alimentation/collaborateur/profil.jpg','https://www.facebook.com/robert.tchitnga','Robert Tchitnga','Enseignant de physics &aacute; l\'universit&eacute; de Dschang');
